...
import { Loader2, Sparkles, Eye, EyeOff, Home, KeyRound } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24">
          <div className="flex items-center gap-3 mb-8">
            <AppLogo
              ...
              wordmarkClassName="text-3xl gradient-text"
            />
          </div>
          <h1 className="text-4xl xl:text-5xl font-display font-bold text-foreground mb-6 leading-tight">
            Streamline your <br />
            <span className="gradient-text">booking business</span>
          </h1>
          <p className="text-lg text-muted-foreground max-w-md">
            The all-in-one platform for managing appointments, clients, and your team. Built for modern service businesses.
          </p>
          <div className="mt-12 flex items-center gap-4">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="h-10 w-10 rounded-full bg-secondary border-2 border-background flex items-center justify-center"
                >
            ...
            <p className="text-sm text-muted-foreground">
              Join 1,000+ businesses already using Bookly
            </p>
          </div>
        </div>
      </div>
